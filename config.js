const ownerNumber = ["556295715980@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '556295715980' 
...
const urlaudiomenu = 'https://drive.google.com/file/d/10e2ofhN7ZhajeiqCbyeNYtGDi-e30Byb/view?usp=drivesdk'
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO SAITAMA-BOT COM 434 COMANDOS, BATERIA: ${battery}`
}
...
const backgroundmenuimg = `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8wplvZulZUSj5kDQtxZltYrJ5kTixdhk_8A&usqp=CAU`
...
const cr = 'sαiταмα ꪶ𖣂ꫂ 𝒎𝒐𝒅𝒐 𝒔𝒐𝒍𝒐\n' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=556295715980:+55 62 95715980\n' 
+ 'END:VCARD'
